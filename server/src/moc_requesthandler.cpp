...
static constexpr auto qt_meta_stringdata_ZN14RequestHandlerE = QtMocHelpers::stringData(
    "RequestHandler"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14RequestHandlerE[] = {
...
Q_CONSTINIT const QMetaObject RequestHandler::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14RequestHandlerE.offsetsAndSizes,
    qt_meta_data_ZN14RequestHandlerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14RequestHandlerE_t,
        // Q_OBJECT / Q_GADGET
...
void *RequestHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14RequestHandlerE.stringdata0))
