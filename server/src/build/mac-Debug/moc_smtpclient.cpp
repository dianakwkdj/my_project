...
void SMTPClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (SMTPClient::*)(bool , const QString & );
            if (_q_method_type _q_method = &SMTPClient::finished; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SMTPClient::finished(bool _t1, const QString & _t2)
{
